...
document.getElementById('gerarCodigo').addEventListener('click', function () {
  const codigoPix = "00020126850014BR.GOV.BCB.PIX01361ccf5854-1abf-4586-a1a8-13a9b63378d00223Exemplo.5204000053039865802BR5923Douglas de Sales Santos6009SAO PAULO61080540900062240520p2jONxnQrhAvmiU3ftc563045BF8";
...
document.getElementById('whatsappButton').addEventListener('click', function () {
  const numeroWhatsApp = "34991671917";
...
document.getElementById("btn-scroll").addEventListener("click", function () {
    ...
    if (form) {
      form.scrollIntoView({ behavior: "smooth" }); // rolagem suave até o formulário
    }
  });